...
- (void)setupUI {
    ...
    [_left setFrame:CGRectMake(10, 74, 100, 30)];
    [_left setBackgroundColor:[UIColor blueColor]];
    [_left setTitle:@"选择难度" forState:UIControlStateNormal];
    [_left addTarget:self action:@selector(popView) forControlEvents:UIControlEventTouchUpInside];
