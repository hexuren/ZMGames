...
- (instancetype)initWithSize:(CGSize)size time:(float)time num:(int)num
{
    if (self = [super initWithSize:size]) {
        ...
        SKLabelNode *timeLabel = [SKLabelNode labelNodeWithText:[NSString stringWithFormat:@"不可思议！你家小明竟然坚持了%0.1f秒",[TimeManager shareInstance].timeCount]];
        ...
        SKSpriteNode *startNode = [[SKSpriteNode alloc] initWithColor:[UIColor clearColor] size:CGSizeMake(210, 60)];
        ...
        SKSpriteNode *returnNode = [[SKSpriteNode alloc] initWithColor:[UIColor clearColor] size:CGSizeMake(210, 60)];
